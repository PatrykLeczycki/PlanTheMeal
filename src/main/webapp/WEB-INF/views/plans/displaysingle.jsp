<tr class="d-flex">
    ...
    <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
        <a href="${pageContext.request.contextPath}/user/plan/delete/${plan.id}" onclick="return confirm('Are you sure you want to delete this album?');" class="btn btn-danger rounded-0 text-light m-1">Delete</a>
