<tr class="d-flex">
    ...
    <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
        ...
        <c:if test="${recipe.author.email == loggedUser}">
            <a href="${pageContext.request.contextPath}/user/recipe/delete/${recipe.id}" onclick="return confirm('Are you sure you want to delete this recipe?');" class="btn btn-danger rounded-0 text-light m-1">Delete</a>
